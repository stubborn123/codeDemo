package com.es.example.demo;

import com.alibaba.fastjson.JSON;
import com.es.example.demo.DO.User;
...
class EsdemoApplicationTests {
    ...
    public static final String INDEX = "zp_test_index";

    @Autowired
    //这个读取@bean要不用人家的原名或者在配置类搞个别名，要不在使用的地方指定好
    ...
    //注意这里要是发现获取返回结果提示警告，拿不到结果，要考虑ES security的设置
    ...
    void testUpdateDocument() throws IOException {
        ...
        User user = new User("法外狂徒格雷福斯", 18);
